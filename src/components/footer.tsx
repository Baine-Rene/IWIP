          ...
          <div className="max-w-(--breakpoint-xl) mx-auto ">
            <div className="py-12 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 gap-x-8 gap-y-10 px-6 xl:px-0">
              <div className="col-span-full xl:col-span-3">
                ...
                <p className="mt-4 text-white max-w-2xl">
                  Designed to empower young people by fostering the right
                  mindset, building leadership skills, and nurturing
                  entrepreneurial thinking to help them unlock their potential
            ...
            <div className="py-8 flex flex-col-reverse sm:flex-row items-center justify-between gap-x-2 gap-y-5 px-6 xl:px-0">
              ...
              <span className="text-white">
                &copy; {new Date().getFullYear()} <Link href="/">IWIP</Link>.
                All rights reserved.
              </span>
            </div>
          </div>
